...
const EditProductForm = ({ deckId, onSubmit, onEdit, productId }) => {
  ...
  // ...addField, updateField, handleSubmit functions
      ...
      <FormControl id="details" mt={4} isRequired>
        ...
        {details.map((detail, index) => (
          <Textarea
            ...
            value={detail}
            onChange={e =>
              updateField(details, setDetails, index, e.target.value)
            }
            mt={index > 0 ? 2 : 0}
          />
        ))}
      ...
      <FormControl id="pricing" mt={4} isRequired>
        ...
        {pricing.map((price, index) => (
          <Textarea
            ...
            value={price}
            onChange={e =>
              updateField(pricing, setPricing, index, e.target.value)
            }
            mt={index > 0 ? 2 : 0}
          />
        ))}
      ...
      <FormControl id="descriptions" mt={4} isRequired>
        ...
        {descriptions.map((price, index) => (
          <Textarea
            ...
            value={price}
            onChange={e =>
              updateField(descriptions, setDescriptions, index, e.target.value)
            }
            mt={index > 0 ? 2 : 0}
          />
        ))}
